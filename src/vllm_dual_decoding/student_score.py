...
from vllm_dual_decoding.common import read_jsonl, write_jsonl


DEFAULT_STUDENT_MODEL = "/home/disk1/public_checkpoint/Qwen3-1.7B"
DEFAULT_INPUT_FILE = "result/vllm_dual_decoding/candidates/smoke/teacher_plain/candidate_pool.jsonl"
DEFAULT_OUTPUT_FILE = "result/vllm_dual_decoding/candidates/smoke/teacher_plain/scored_candidates.jsonl"


def build_arg_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Score token-level vLLM-dual candidate outputs with the student base model."
    )
...
def build_scoring_feature(record: dict[str, Any], tokenizer, max_length: int) -> tuple[dict[str, list[int]], bool]:
    ...
    return {"prompt_ids": prompt_ids, "input_ids": full_ids}, len(full_ids) > max_length
