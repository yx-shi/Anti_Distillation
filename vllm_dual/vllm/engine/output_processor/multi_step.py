...
class MultiStepOutputProcessor(SequenceGroupOutputProcessor):
    ...
    def _process_seq_outputs(self, seq: Sequence,
        ...
        is_interveneds = [sample.is_intervened for sample in valid_samples]
        ...
        # token.
        for output_token_id, output_logprob, is_intervened in zip(output_token_ids,
                                                   output_logprobs, is_interveneds):
            seq.append_token_id(
