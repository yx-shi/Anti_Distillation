...
class RunExperimentCliTest(unittest.TestCase):
    def test_parse_stage_list_accepts_comma_separated_aliases(self) -> None:
        self.assertEqual(
            parse_stage_list("teacher_generate,students_score,build_distill,analyze_data,result_summary"),
            ["teacher_generate", "student_score", "build_distill", "data_summary", "final_summary"],
        )
